...
import MobileTransactionView from './components/MobileTransactionView.vue'
...
<template>
  <div class="app-container">
        ...
        <ul class="nav-list">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link" 
               ...
               @click.prevent="navigateTo('mobile')">
              <span class="nav-icon">📱</span>
              <span class="nav-text">Mobile View</span>
            </a>
          </li>
        </ul>
      </nav>
    ...
    <main>
      ...
      <MobileTransactionView v-if="activeTab === 'mobile'" />
    </main>
